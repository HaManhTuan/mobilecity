                ...
                <ul class="nav metismenu" id="side-menu">
                    <li class="nav-header">
                        <div class="dropdown profile-element">
                            <img alt="image" class="rounded-circle" src="backend/img/profile_small.jpg"/>
                    ...
                    <li class="active">
                        <a href="{{ route('admin.dashboard.index') }}"><i class="fa fa-th-large"></i> <span class="nav-label">Quản trị</span></a>
                    </li>
                    <li>
                        <a href=""><i class="fa fa-diamond"></i> <span class="nav-label">Danh mục</span><span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level collapse">
                            <li><a href="{{ route('admin.categoryPro.index') }}">Danh mục sản phẩm</a></li>
                            <li><a href="graph_morris.html">Danh mục tin tức</a></li>
                        </ul>
                    </li>
                    <li>
                        ...
                        <ul class="nav nav-second-level collapse">
                            ...
                            <li><a href="graph_morris.html">Morris.backend/js Charts</a></li>
                            <li><a href="graph_rickshaw.html">Rickshaw Charts</a></li>
                            <li><a href="graph_chartbackend/js.html">Chart.backend/js</a></li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level collapse">
                            ...
                            <li><a href="helper_classes.html">Helper backend/css classes</a></li>
                    ...
                    <li>
                        <a href="backend/css_animation.html"><i class="fa fa-magic"></i> <span class="nav-label">backend/css Animations </span><span class="label label-info float-right">62</span></a>
                    </li>
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-messages dropdown-menu-right">
                            <li>
                                <div class="dropdown-messages-box">
                                    <a class="dropdown-item float-left" href="profile.html">
                                        <img alt="image" class="rounded-circle" src="backend/img/a7.jpg">
                                    </a>
                            ...
                            <li>
                                <div class="dropdown-messages-box">
                                    <a class="dropdown-item float-left" href="profile.html">
                                        <img alt="image" class="rounded-circle" src="backend/img/a4.jpg">
                                    </a>
                                    <div class="media-body ">
                            ...
                            <li>
                                <div class="dropdown-messages-box">
                                    <a class="dropdown-item float-left" href="profile.html">
                                        <img alt="image" class="rounded-circle" src="backend/img/profile.jpg">
                                    </a>
                                    <div class="media-body ">
